...
import { boolean, number, select as selectAddons } from '@storybook/addon-knobs'
import { Container, Image } from '@titicaca/core-elements'

import { FRAME_RATIO_AND_SIZES, GLOBAL_SIZES } from './image-knob-options'
  ...
  <Container>
    <Image>
      <Image.FixedRatioFrame
        frame={
          boolean('frame 사용', true)
            ? selectAddons('frame', FRAME_RATIO_AND_SIZES, 'mini')
            : undefined
        }
      >
        <Image.OptimizedImg
          loading="eager"
          cloudinaryId="45a36898-b412-4d51-882c-fdefad5a164d"
        />
      </Image.FixedRatioFrame>
    </Image>
    <Image>
    ...
    <Container minHeight={10000}>{''}</Container>
    <Image>
      <Image.FixedRatioFrame
        frame={
          boolean('frame 사용', true)
...
<Story name="가로, 세로 고정 프레임">
  <Image>
    <Image.FixedDimensionsFrame
      size={
        !boolean('width, height 사용', true)
          ? selectAddons('size', GLOBAL_SIZES, 'medium')
          : undefined
      }
      width={
        boolean('width, height 사용', true)
          ? number('width', 320, undefined)
          : undefined
      }
      height={
        boolean('width, height 사용', true)
          ? number('height', 180, undefined)
          : undefined
      }
    >
      <Image.Img src="https://triple-corp.com/static/images/img-bg-0.jpg" />
...
<Story name="오버레이">
  <Image>
    <Image.FixedRatioFrame frame="mini">
      <Image.Img src="https://triple-corp.com/static/images/img-bg-0.jpg" />
      <Image.Overlay
        overlayType={selectAddons('overlayType', ['gradient', 'dark'], 'dark')}
...
<Story name="원형 이미지">
  <Image.Circular
    ...
    size={
      !boolean('width 사용', false)
        ? selectAddons('size', ['small', 'medium'], 'medium')
        : undefined
    }
    width={boolean('width 사용', false) ? number('width', 40) : undefined}
  />
</Story>
