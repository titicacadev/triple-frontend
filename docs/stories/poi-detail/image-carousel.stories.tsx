...
export const AttractionOrRestaurant = () => {
    ...
    <UserAgentProvider value={userAgentValues}>
      ...
      >
        <ImageCarousel
          ...
          todayBusinessHours={hasBusinessHours ? todayBusinessHours : undefined}
...
AttractionOrRestaurant.storyName = 'Attraction / Restaurant'
