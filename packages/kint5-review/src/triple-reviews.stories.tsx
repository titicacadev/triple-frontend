...
import { TripleReviews } from '.'

const queryClient = new QueryClient()

const meta: Meta<typeof TripleReviews> = {
  title: 'kint5-review / Triple Reviews',
  component: TripleReviews,
  decorators: [
    (Story) => (
      <>
        <Story />
    ...
    (Story) => (
      <FilterProvider>
        <SortingOptionsProvider resourceId="">
          <ReviewLanguageProvider reviewLang="ko" userLang="ja">
            <Story />
...
export const Basic: StoryObj<typeof TripleReviews> = {
  name: '일반',
  args: {
...
export const HasMyReview: StoryObj<typeof TripleReviews> = {
  name: '내 리뷰 작성됨',
  args: {
    ...Basic.args,
  },
