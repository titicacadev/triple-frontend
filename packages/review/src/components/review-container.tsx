...
import { ReviewScript } from '@titicaca/meta-tags'
...
function ReviewContainer({
  ...
  return (
    <>
      <ReviewScript
        reviews={reviewsData.map(({ comment, user, rating }) => ({
          itemReviewed: {
            type: 'attraction',
            name: '', // TODO poi or tna title
          },
          name: comment,
          author: {
            name: user.name,
      ...
      <Section anchor={REVIEWS_SECTION_ID}>
        ...
        {isLoaded ? (
          <>
            ...
            {totalReviewsCount > SHORTENED_REVIEWS_COUNT_PER_PAGE &&
            shortened ? (
              <Container
                css={{
                  margin: '40px 0 0',
